      ...
      <div className="flex-1 overflow-auto">
        <div className="mx-auto max-w-lg px-4 py-6 sm:px-6">
          <p className="text-sm text-ink/60">
            ...
            else sees it marked as restricted. Add someone by the email their login was created
            with. This app has no public sign-up, so if they don't have a login yet, create one
            first in Supabase → Authentication → Users → Add user.
          </p>
